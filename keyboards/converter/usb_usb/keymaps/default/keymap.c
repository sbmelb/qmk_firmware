...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    QUOTES,    CAPS,     KC_W,     KC_E,     UND,      KC_T,     KC_Y,     KC_U,     KC_I,     KC_O,     KC_P,     KC_LBRC,   KC_RBRC,             KC_BSLS,     KC_DEL,    KC_END,    KC_PGDN,    KC_P7,     KC_P8,     KC_P9,     KC_PPLS,    KC_MENU, KC_UNDO,
    ...
    KC_LCTL,   UNDO,     REDO,     KC_INT5,  KC_LNG2,            KC_SPC,             KC_LNG1,  KC_INT4,  KC_INT2,  KC_RALT,   KC_RGUI,  KC_APP,    KC_RCTL,     KC_LEFT,   KC_DOWN,   KC_RGHT,    KC_P0,              KC_PDOT,   KC_PENT,    KC_FIND, KC_CUT
    ),
    [1] = LAYOUT_all(
