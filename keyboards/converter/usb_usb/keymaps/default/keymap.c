...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    KC_LCTL,   UNDO,     REDO,     KC_INT5,  KC_LNG2,            KC_SPC,             LEFT_INDENT,  RIGHT_INDENT, KC_INT2,   KC_RALT,   KC_RGUI,   KC_APP,    KC_RCTL,     KC_LEFT,   KC_DOWN,   KC_RGHT,    KC_P0,              KC_PDOT,   KC_PENT,    KC_FIND, KC_CUT
    ),
    [1] = LAYOUT_all(
